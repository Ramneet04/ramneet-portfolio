...
const ProjectCard = ({project}) => {
  return (
    <div class="parent text-white w-[60%]">
        <div class="card ">
            <div class="logo">
            </div>
            <div class="glass  border border-accent/30 border-solid backdrop-blur-[6px] shadow-glass-inset hover:shadow-glass-sm bg-transparent"></div>
            <div class="content ">
                <span class="title rounded-xl w-fit">UIVERSE (3D UI)</span>
                <span class="text rounded-xl bg-white w-fit">Create, share, and use beautiful custom elements made with CSS</span>
            </div>
            <div class="bottom ">
