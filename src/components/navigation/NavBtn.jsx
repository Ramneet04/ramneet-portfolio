  ...
  return (
    <ResponsiveComponent>
        {({size})=>{
            ...
            <div className='w-fit absolute cursor-pointer z-50' style={{transform: `translate(${x}, ${y})`}}>
            ...
            <span className=' absolute hidden peer-hover:block px-2 py-1 left-full mx-2 top-1/2 -translate-y-1/2 bg-background text-foreground text-sm rounded-lg shadow-sm shadow-yellow-200 whitespace-nowrap'>{label}</span>
            </span>
            </Link>
        </div>
        : 
