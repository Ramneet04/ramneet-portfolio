...
const Wizard = React.memo(function Wizard(props) {
  ...
  //code runs on every frame renders
  useFrame((state, delta, XrFrame)=>{
    // console.log(state.clock);
    // sin provides value from -1 to 1 as sin function   Math.sin 
    //time will always change
    modelRef.current.position.y= -1.6 + Math.sin(state.clock.elapsedTime)*0.3;
